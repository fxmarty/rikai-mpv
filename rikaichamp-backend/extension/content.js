...
export class RikaiContent {
    ...
    getTextFromTextNode(input, maxLength) {
        let result = {
            text: '',
            rangeStart: {
    ...
    async tryToUpdatePopup(my_input, dictMode) {
    ...
    getTextAtPoint(my_input, maxLength) {
    ...
    showPopup(options) {
        ...
        const popupOptions = Object.assign({ accentDisplay: this._config.accentDisplay, copyIndex: this._copyIndex, copyNextKey: this._config.keys.startCopy[0] || '', copyState: this._copyMode ? 1 /* Active */ : 0 /* Inactive */, meta: (_a = this._currentTextAtPoint) === null || _a === void 0 ? void 0 : _a.result.meta, popupStyle: this._config.popupStyle, posDisplay: this._config.posDisplay, showDefinitions: !this._config.readingOnly, showKanjiComponents: this._config.showKanjiComponents, showPriority: this._config.showPriority }, options);
...
function extractGetTextMetadata(text) {
    // Look for a year
    ...
    if (typeof matches[1] !== 'undefined') {
        ...
        if (firstCharCode >= 0x4e00 && firstCharCode <= 0x9fff) {
            ...
            year = parseInt(matches[1].replace(/[０-９]/g, (ch) => String.fromCharCode(ch.charCodeAt(0) - 0xfee0)), 10);
        }
    }
    if (year === null) {
        return undefined;

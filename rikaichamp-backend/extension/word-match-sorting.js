...
export function sortMatchesByPriority(results) {
    results.sort((a, b) => getPriority(b) - getPriority(a));
    return results;
}
export function getPriority(match) {
    const scores = [0];
...
const PRIORITY_ASSIGNMENTS = new Map([
    ['i1', 50],
    ['i2', 20],
    ['n1', 40],
    ['n2', 20],
...
//# sourceMappingURL=word-match-sorting.js.map